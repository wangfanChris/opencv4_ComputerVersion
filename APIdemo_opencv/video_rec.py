...
"""
python video_rec.py /home/wangfan/Desktop/ShareVmware/pycv/data/at 
/home/wangfan/Desktop/ShareVmware/pycv/data/at/jm
"""
...
#                continue
            for filename in os.listdir(subject_path):
                try:
                    ...
                    if (sz is not None):
                        im = cv2.resize(im, (200, 200), dtype=np.uint8) 
                    temp = np.asarray(im, np.uint8)
                    X.append(temp)
                    y.append(c)
                except IOError as e:
